...
use crate::account::credentials::{MAL_API, MAL_AUTH_URL, MAL_REDIRECT_URI, MAL_TOKEN_URL};
...
impl UserListProvider for MalProvider {
    ...
    fn auth_url(&self, _pkce: &Pkce, _state: &str) -> String {
        // Stub — implemented in the next red+green pair.
        String::new()
    }
...
// Suppress unused-imports warning until the methods land that use them.
const _: &str = MAL_AUTH_URL;
const _: &str = MAL_REDIRECT_URI;
const _: &str = MAL_USER_AGENT;
