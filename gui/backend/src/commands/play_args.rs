...
//!
//! They live outside `commands::play` so the play module's
//! cyclomatic complexity stays manageable; the
//! `deserialize_with = "..."` attributes on `PlayArgs` therefore
//! carry the full `crate::commands::play_args::*` path.
//!
