//! Wrapper-script provisioning for the botan shim: pid-scoped
//! directories, shell-safe path serialization, and best-effort pruning
//! of dead siblings. Split from the dispatcher so each file stays a
//! small unit under the per-file complexity ratchet.
